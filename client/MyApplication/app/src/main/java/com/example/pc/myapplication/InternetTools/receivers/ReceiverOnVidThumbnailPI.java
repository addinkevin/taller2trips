...
public class ReceiverOnVidThumbnailPI extends BroadcastReceiver{
    private View view;
    private StringBuilder heightVideo;
    private StringBuilder weigthVideo;

    public ReceiverOnVidThumbnailPI(View img, StringBuilder heightVideo, StringBuilder weigthVideo) {
        this.view = img;
